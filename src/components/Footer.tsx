        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-3 text-sm text-gray-500 max-w-xs">
              Connecting patients with healthcare professionals, medical facilities, and services
              for better healthcare access.
            </p>
          </div>

          <div>
            <h3 className="font-medium text-gray-900 mb-3">For Patients</h3>
          ...
          <div>
            <h3 className="font-medium text-gray-900 mb-3">For Healthcare Providers</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a href="#" className="text-gray-600 hover:text-medical-600 transition-colors">
                  Join as Doctor
