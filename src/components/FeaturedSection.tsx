...
const typeColors = {
  ...
  hospital: "bg-orange-50 text-orange-700 border-orange-200",
};
  ...
  return (
    <section className="py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-900">Featured Healthcare</h2>
          <p className="mt-2 text-gray-600">Top-rated healthcare providers in your area</p>
        </div>
